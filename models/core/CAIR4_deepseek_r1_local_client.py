"""
===========================================================
DeepSeek R1 API Client (query_deepseek_r1.py)
===========================================================

Dieses Modul stellt eine Schnittstelle zur **lokalen DeepSeek R1 API** bereit und ermöglicht 
die Verarbeitung von Benutzeranfragen mit kontextabhängigen Prompts über **Ollama**.

📌 Funktionen:
- **query_deepseek_r1()** → Sendet eine Anfrage an das lokal installierte DeepSeek R1 Modell.
...
# === 2️⃣  Hauptfunktion zur Kommunikation mit DeepSeek R1 ===
def query_deepseek_r1(prompt, context="", model_name="deepseek-r1", max_length=200):
    """
    Sendet eine Anfrage an das lokal installierte DeepSeek R1 Modell über Ollama.

    Args:
        prompt (str): Die Eingabeaufforderung für das Modell.
        context (str): Optionaler Kontext für genauere Antworten.
        model_name (str): Das zu verwendende Modell (Standard: "deepseek-r1").
